function icasig = fastICA(im, r, varargin)
...
if jumpWhitening == 3
    ...
    if jumpPCA == 2,
        ...
        % Calculate PCA
        [E, D]=pcamat(mixedsig, firstEig, lastEig, interactivePCA, 'off');
    end
end
...
if only > 2
    ...
    [A, W] = fpica (whitesig,  whiteningMatrix, dewhiteningMatrix, approach, ...
        ...
        displayMode, displayInterval, 'off');
